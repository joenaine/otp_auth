...
abstract class $AuthUserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String phoneNumber, String? email, String? photo});
}
...
class _$_AuthUserModel extends _AuthUserModel {
  const _$_AuthUserModel(
      {required this.id, required this.phoneNumber, this.email, this.photo})
      : super._();
  ...
  @override
  String toString() {
    return 'AuthUserModel(id: $id, phoneNumber: $phoneNumber, email: $email, photo: $photo)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, phoneNumber, email, photo);
...
abstract class _AuthUserModel extends AuthUserModel {
  const factory _AuthUserModel(
      ...
      final String? email,
      final String? photo}) = _$_AuthUserModel;
